...
import { EnumValuesDto, ProjectId, TaskFieldDto, TaskFieldId, UpdateTaskFieldDto } from './dto/task-field.dto';
...
export class TaskFieldsController {
  ...
  createEnumValueList(@Payload() dto: EnumValuesDto) {
    return this.taskFieldsService.createEnumValueList(dto);
  }
}
